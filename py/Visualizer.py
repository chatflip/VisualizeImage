...
class Visualizer(object):
    ...
    def gray(self, image, filename):
        gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
        cv2.imwrite(filename % "gray", gray)

    def color_channel(self, image, filename):
    ...
    def gray_gradient(self, image, filename):
        gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
    ...
    def color_gradient(self, image, filename):
    ...
    def power_spectrum(self, image, filename):
        gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
        gray = np.array(gray)
    ...
    def draw_keypoint(self, image, filename):
    ...
    def make_sift_image(self, image):
        gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
        kp_image = image.copy()
    ...
    def make_akaze_image(self, image):
        gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
        kp_image = image.copy()
        rich_image = image.copy()
    ...
    def make_dense_image(self, image):
        gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
        kp_image = image.copy()
        rich_image = image.copy()
    ...
    def draw_hog(self, image, filename):
        gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
    ...
    def draw_lbp(self, image, filename):
